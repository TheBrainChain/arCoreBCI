    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        public void Update ()
        {
            ...
            if (Session.Raycast(m_firstPersonCamera.ScreenPointToRay(touch.position), raycastFilter, out hit))
            {
				...
				andyObject.transform.position =new Vector3(Mathf.PingPong(Time.time*2,andyObject.transform.position.x+3-andyObject.transform.position.x)+andyObject.transform.position.x, transform.position.y, transform.position.z);
            }
